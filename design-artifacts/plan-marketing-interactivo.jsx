...
const MONTHS = [
  {
    ...
    weeks: [
      {
        id: "w1", name: "Semana 1", focus: "Activar WhatsApp Business",
        priority: "red", owner: "Persona de agenda", time: "4 horas",
        tasks: [
          { id: "t1_1", text: "Descargar e instalar WhatsApp Business en el celular de atención al paciente" },
          { id: "t1_2", text: "Configurar perfil completo: logo, descripción, dirección, horario y sitio web" },
          { id: "t1_3", text: "Crear mensaje de bienvenida automático (responde en menos de 2 horas)" },
          { id: "t1_4", text: "Crear mensaje de ausencia automático (fuera de horario)" },
          { id: "t1_5", text: "Crear respuestas rápidas: Horarios, Convenios, Cómo agendar, Dirección" },
          { id: "t1_6", text: "Crear etiquetas: Nuevo paciente / Confirmó / No confirmó / Cancelado" },
        ]
      },
      {
        id: "w2", name: "Semana 2", focus: "Protocolo de recordatorios",
        priority: "red", owner: "Persona de agenda", time: "2h setup + 15 min/día",
        tasks: [
          { id: "t2_1", text: "Crear plantilla de confirmación al agendar (fecha, hora, qué traer)" },
          { id: "t2_2", text: "Crear plantilla de recordatorio 48h antes de la consulta" },
          { id: "t2_3", text: "Crear plantilla de recordatorio 24h antes de la consulta" },
          { id: "t2_4", text: "Crear plantilla post no-show (48h después, tono empático, invitar a reagendar)" },
          { id: "t2_5", text: "Asignar responsable del envío diario de recordatorios (15 min/día)" },
          { id: "t2_6", text: "Crear planilla Google Sheets de seguimiento de pacientes agendados" },
        ]
      },
      {
        id: "w3", name: "Semana 3", focus: "Optimizar Google My Business",
        priority: "red", owner: "Creadora de contenido + 1 médico", time: "6 horas",
        tasks: [
          { id: "t3_1", text: "Ingresar a business.google.com y reclamar/verificar la ficha" },
          { id: "t3_2", text: "Completar categorías: Clínica médica + Ginecólogo, Urólogo, Kinesiólogo, Traumatólogo, Nutricionista" },
          { id: "t3_3", text: "Subir 20+ fotos: fachada, recepción, boxes, equipo (con autorización), equipamiento" },
          { id: "t3_4", text: "Activar mensajería directa desde la ficha de Google" },
          { id: "t3_5", text: "Enviar link de reseña a 10 pacientes habituales por WhatsApp para las primeras reseñas" },
          { id: "t3_6", text: "Publicar primera novedad: 'Conoce a nuestro equipo de urólogos'" },
        ]
      },
      {
        id: "w4", name: "Semana 4", focus: "Reactivar Facebook y ordenar Instagram",
        priority: "orange", owner: "Creadora de contenido", time: "8 horas",
        tasks: [
          { id: "t4_1", text: "Actualizar página de Facebook: horarios, dirección, web y WhatsApp" },
          { id: "t4_2", text: "Subir foto de portada actualizada con identidad visual de Mediterra" },
          { id: "t4_3", text: "Configurar botón de acción en Facebook: 'Enviar mensaje'" },
          { id: "t4_4", text: "Publicar presentación del equipo completo en Facebook" },
          { id: "t4_5", text: "Optimizar bio de Instagram: especialidades + ubicación + link de agendamiento" },
          { id: "t4_6", text: "Crear 6 destacados en Instagram: Ginecología | Urología | Kinesiología | Traumatología | Psicología | Nutrición" },
          { id: "t4_7", text: "Definir plantilla visual para todos los posts (colores y tipografía Mediterra)" },
        ]
      },
    ]
  },
...
const CHECKLIST = [
  ...
  { id: "c5", text: "Descargar e instalar WhatsApp Business hoy mismo" },
